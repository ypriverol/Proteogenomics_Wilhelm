    ...
    tabsetPanel(
        tabPanel("About", div(
            ...
            p("
              ...
              $$\\hat{\\text{protein}}_i = \\hat{r} \\cdot \\text{mRNA}_i,$$
              where
              $$\\hat{r} = \\operatorname{Med}_{i = 1, \\dotsc, n} (\\text{protein}_i / \\text{mRNA}_i).$$
             "),

            p("We built this application to visualize all the data generated by Wilhelm et al."),
            p("
