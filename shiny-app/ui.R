...
shinyUI(fluidPage(
    ...
    tabsetPanel(
        tabPanel("About", div(
            ...
            p("Wilhelm et al. have claimed that the ratio of protein to mRNA levels remains remarkably conserved across tissues for any given gene (at steady state). 
Therefore, they proposed using the median ratio of protein to mRNA levels as a proxy of the gene-specific translation rate constant to predict protein abundance, i.e.,
              ...
              In the tab called "Gene Plots", we illustrate the ratios of protein to mRNA levels (and its median value) for 5895 genes. In addition, we show the scatter plots of 
              the measured mRNA versus protein levels, as well as their protein predictions versus the observed protein values for each gene.
              
              Detailed explanations and interpretations of these plots are given in a brief article, currently under review in Nature"),
            h4("References"),
